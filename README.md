...
|  5   | [Print elements in sorted order using row-column wise sorted matrix](https://practice.geeksforgeeks.org/problems/sorted-matrix2333/1)                 |   [Sol](https://github.com/Sumandeep-Kaur/DSA-450/blob/master/Matrix/05.%20Sort%20matrix.cpp)     |    _O(n<sup>2</sup>logn)_    |  _O(n<sup>2</sup>)_  |
...
|  8   | [Rotate matrix by 90 degrees](https://www.geeksforgeeks.org/rotate-a-matrix-by-90-degree-in-clockwise-direction-without-using-any-extra-space/)                 |   [Sol](https://github.com/Sumandeep-Kaur/DSA-450/blob/master/Matrix/08.%20Rotate%20matrix%20by%2090%20degrees.cpp)    |   _O(n<sup>2</sup>)_      |  _O(1)_   |
...
|  11  | [Find all quadruples that sum up to given value](https://practice.geeksforgeeks.org/problems/find-all-four-sum-numbers1732/1#)                                   |  [Sol](https://github.com/Sumandeep-Kaur/DSA-450/blob/master/Search%20%26%20Sort/11.%20Find%20four%20no's%20with%20given%20sum.cpp)     |  _O(n<sup>3</sup>)_    |  _O(1)_   |
...
|  5  | [Mirror tree of binary tree](https://www.geeksforgeeks.org/create-a-mirror-tree-from-the-given-binary-tree/)                                   | [Sol](https://github.com/Sumandeep-Kaur/DSA-450/blob/master/Binary%20Tree/05.%20Mirror%20tree.cpp)    |  _O(n)_    |  _O(n)_    |
...
|  4  | [Count total number of set bits from 1 to n](https://practice.geeksforgeeks.org/problems/count-total-set-bits-1587115620/1)                                   | [Sol](https://github.com/Sumandeep-Kaur/DSA-450/blob/master/Bit%20Manipulation/04.%20Total%20set%20bits%20till%20n.cpp)      | _O(logn)_    |  _O(1)_    |
